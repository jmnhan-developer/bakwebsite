...
import { Card, CardImg, Container, Row } from 'reactstrap';
    ...
    return (
        <Container>
            ...
            <Row>
                <Col xs="12" lg="6">
                    <Card>
                        <CardImg top width="400px" src={props.product.images} alt="Card image cap" />
                    </Card>
                </Col>
                <Col xs="12" lg="6">
                    ...
                    <Row style={{ display: "flex", justifyContent: "center" }}>
                        <Button style={{ width: 200, backgroundColor: "#16bfc4", border: "none", marginTop: 13 }} onClick={() => {setGoToProduct(true)}}>Acheter</Button>
                    </Row>
                </Col>
            </Row>
        </Container>
